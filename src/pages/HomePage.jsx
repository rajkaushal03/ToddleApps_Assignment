...
function HomePage() {
  ...
  const handleDownload = (fileName) => {
    ...
    const fileURL = `/${fileName}`; // Replace this with the actual file URL
            ...
            <div className="absolute flex items-center justify-center w-screen h-screen bg-gray-200">
              <div className="shadow-lg bg-white shadow-gray-500 w-1/3  rounded-md p-6">
                <form>
                  ...
                  {linksec && (
                    <div className="flex flex-col justify-center mt-8 m-2">
                      <div className="m-2 mt-4 font-semibold">Display name</div>
                ...
                >
                  {allTodos.map((item, index) => {
                    if (item.filename !== null && item.filename !== "") {
                      ...
                      return (
                        <>
                          <div className="flex justify-between w-2/3 border-2 border-gray-200  rounded-md mb-10 cursor-pointer">
